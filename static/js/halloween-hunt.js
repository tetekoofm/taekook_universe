...
// --- Popup overlay (only once per session) ---
if (!sessionStorage.getItem("halloweenPopupShown")) {
  ...
  popup.style.cssText = `
    ...
    color: #ff6fff; font-family: 'Creepster', cursive; text-align: center;
    padding: 20px;
  `;
...
`;
  ...
  function spawnIcons() {
    ...
    img.addEventListener("click", (e) => {
      ...
      document.querySelector(".halloween-counter span").textContent = `🎃 ${foundIcons.length} / ${totalToFind} found`;
